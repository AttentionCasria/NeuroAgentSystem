...
from langchain.schema import StrOutputParser  # 添加输出解析器
from langchain.chat_models import ChatOpenAI  # 替换导入
...
def make_chain():
    ...
    if not api_key:
        raise ValueError("未找到环境变量 DEEPSEEK_API_KEY，请设置该环境变量")
